  ...
  <style>
    ...
    * {
    ...
    .splash-share-btn {
      ...
      justify-content: center;
      gap: 8px;
      background: linear-gradient(135deg, rgba(37, 211, 102, 0.25) 0%, rgba(18, 140, 126, 0.42) 100%);
      ...
      border-radius: 20px;
      cursor: pointer;
      box-shadow: 0 0 18px rgba(37, 211, 102, 0.45), inset 0 0 10px rgba(37, 211, 102, 0.25);
      transition: all 0.2s ease;
      margin-top: 4px;
    }

    .splash-share-btn:hover {
      background: linear-gradient(135deg, rgba(37, 211, 102, 0.45) 0%, rgba(18, 140, 126, 0.65) 100%);
      box-shadow: 0 0 28px rgba(37, 211, 102, 0.8);
      transform: scale(1.02);
    }

    .splash-share-btn:active {
    ...
    /* ==========================================================================
       CARTEL DE RUTA CON FOQUITOS EN MOVIMIENTO (HIGHWAY MARQUEE BULB SIGN)
       ========================================================================== */
    .marquee-sign-box {
      position: relative;
      display: flex;
    ...
    .splash-title.marquee-bulb-title {
      ...
      line-height: 1.15;
      color: #ffe600;
      /* Foquitos incandescentes dentro de los caracteres */
      background: 
        radial-gradient(circle, #ffffff 18%, #ffe600 45%, #ff5500 72%, transparent 82%),
        linear-gradient(90deg, #ffe600, #ff007f, #00f3ff, #ffe600);
    ...
    @keyframes marqueeBulbMotion {
      0% {
        background-position: 0px 0px, 0% 50%;
        filter: drop-shadow(0 0 8px rgba(255, 230, 0, 0.7)) drop-shadow(0 0 18px rgba(255, 102, 0, 0.5));
      }
      50% {
        background-position: 6px 6px, 100% 50%;
        filter: drop-shadow(0 0 16px rgba(255, 240, 60, 0.98)) drop-shadow(0 0 28px rgba(255, 0, 127, 0.85));
      }
      100% {
        background-position: 12px 12px, 200% 50%;
        filter: drop-shadow(0 0 8px rgba(255, 230, 0, 0.7)) drop-shadow(0 0 18px rgba(255, 102, 0, 0.5));
      }
    }

    /* Filas de foquitos de marquesina en movimiento */
    .marquee-bulb-row {
      display: flex;
    ...
    .marquee-bulb-dot {
      ...
      animation: bulbChase 0.75s infinite alternate;
    }

    .marquee-bulb-dot:nth-child(2n) {
      animation-delay: 0.18s;
      background: #ff007f;
      box-shadow: 0 0 7px #ff007f;
    }

    .marquee-bulb-dot:nth-child(3n) {
      animation-delay: 0.36s;
      background: #00f3ff;
      box-shadow: 0 0 7px #00f3ff;
    }

    .marquee-bulb-dot:nth-child(4n) {
    ...
    @keyframes bulbChase {
      ...
      100% { transform: scale(1.35); opacity: 1; filter: brightness(1.6); }
    }

    /* ==========================================================================
       TACÓMETRO GAUGE SEMICIRCULAR DE DIFICULTAD
       ========================================================================== */
    ...
    .gauge-svg {
      ...
      height: 105px;
      overflow: visible;
      filter: drop-shadow(0 0 14px rgba(0, 243, 255, 0.25));
    }
    ...
    /* FILA DE BOTONES JUGAR Y ENTRENAR (LADO A LADO) */
    .splash-action-row {
      display: flex;
      flex-direction: row;
      gap: 10px;
    ...
    .splash-btn-start {
      ...
      border-radius: 12px;
      cursor: pointer;
      box-shadow: 0 0 24px rgba(255, 0, 127, 0.55), inset 0 0 10px rgba(255, 255, 255, 0.35);
    ...
    /* Panel Inferior Elevado (Evita que el aviso del sistema móvil de pantalla completa tape el botón) */
    #bottom-panel {
      width: 100%;
      max-width: 520px;
      display: flex;
      ...
      gap: 7px;
      z-index: 20;
      margin-bottom: clamp(34px, 8.5vh, 62px);
    }
    ...
    .leaderboard-card-wrapper {
      ...
      box-shadow: 0 0 16px rgba(0, 243, 255, 0.15), inset 0 0 12px rgba(0, 243, 255, 0.08);
    }

    /* EFECTO DE LUZ EN BARRIDA DE ARRIBA HACIA ABAJO EN LOS PUESTOS (FX VERTICAL SCAN) */
    .leaderboard-light-sweep-fx {
      position: absolute;
      top: -80px;
      left: 0;
      width: 100%;
      ...
      background: linear-gradient(
        180deg,
        rgba(0, 243, 255, 0) 0%,
        rgba(0, 243, 255, 0.4) 35%,
        rgba(255, 255, 255, 0.95) 50%,
        rgba(0, 243, 255, 0.4) 65%,
        rgba(0, 243, 255, 0) 100%
      );
      box-shadow: 0 0 20px rgba(0, 243, 255, 0.9), 0 0 35px rgba(0, 243, 255, 0.5);
      pointer-events: none;
      animation: leaderboardVerticalSweep 2.5s cubic-bezier(0.4, 0, 0.2, 1) infinite;
      mix-blend-mode: screen;
      z-index: 5;
    }

    @keyframes leaderboardVerticalSweep {
...
<body>
  ...
  <div id="splash-screen">
    <div class="splash-content">
      ...
      <!-- Icono Planisferio Radar ARRIBA -->
      <div class="splash-logo-radar">
        <span class="splash-globe-icon">🌐</span>
      </div>
      
      <!-- CARTEL DE RUTA CON FOQUITOS EN MOVIMIENTO -->
      <div class="marquee-sign-box">
        <div class="marquee-bulb-row">
          <span class="marquee-bulb-dot"></span>
          <span class="marquee-bulb-dot"></span>
          <span class="marquee-bulb-dot"></span>
          <span class="marquee-bulb-dot"></span>
          <span class="marquee-bulb-dot"></span>
        ...
        <h1 class="splash-title marquee-bulb-title" id="txt-splash-title">MI MUNDO</h1>
        <div class="marquee-bulb-row">
          <span class="marquee-bulb-dot"></span>
          <span class="marquee-bulb-dot"></span>
          <span class="marquee-bulb-dot"></span>
      ...
      <!-- TACÓMETRO GAUGE SEMICIRCULAR (VERDE / AMARILLO / ROJO) -->
      <div id="difficulty-gauge-container" class="difficulty-gauge-container">
        <svg class="gauge-svg" viewBox="0 0 200 115">
          <!-- Arco Verde (Fácil • 180° a 122°) -->
          <path id="gauge-arc-easy" class="gauge-segment active" data-diff="easy" d="M 25 95 A 75 75 0 0 1 60.26 31.40" fill="none" stroke="#39ff14" stroke-width="18" stroke-linecap="round" />
          <!-- Arco Amarillo (Medio • 118° a 62°) -->
          <path id="gauge-arc-med" class="gauge-segment" data-diff="medium" d="M 64.79 28.78 A 75 75 0 0 1 135.21 28.78" fill="none" stroke="#ffe600" stroke-width="18" stroke-linecap="butt" />
          <!-- Arco Rojo (Difícil / Experto • 58° a 0°) -->
          <path id="gauge-arc-hard" class="gauge-segment" data-diff="hard" d="M 139.74 31.40 A 75 75 0 0 1 175 95" fill="none" stroke="#ff0033" stroke-width="18" stroke-linecap="round" />
          
          <!-- Aguja / Puntero Neón -->
          <g id="gauge-needle-group" class="gauge-needle" style="transform-origin: 100px 95px; transform: rotate(-60deg); transition: transform 0.35s cubic-bezier(0.34, 1.56, 0.64, 1);">
            <line x1="100" y1="95" x2="100" y2="35" stroke="#ffffff" stroke-width="3.5" stroke-linecap="round" filter="drop-shadow(0 0 6px #00f3ff)" />
            <polygon points="96,48 104,48 100,28" fill="#00f3ff" />
          </g>
          <!-- Tapa Central -->
          <circle cx="100" cy="95" r="9" fill="#0c162d" stroke="#00f3ff" stroke-width="3" />
          <circle cx="100" cy="95" r="3.5" fill="#ffffff" />
        </svg>
        <div id="gauge-selected-label" class="gauge-selected-label" style="color: #39ff14; text-shadow: 0 0 10px #39ff14;">FÁCIL • 16s • x1</div>
      </div>

      <!-- BOTONES JUGAR Y ENTRENAR UNO AL LADO DEL OTRO -->
      <div class="splash-action-row">
        <button id="splash-start-btn" class="splash-btn-start">JUGAR</button>
        <button id="splash-train-btn" class="splash-btn-train">ENTRENAR</button>
      </div>

      <!-- Banderas Selector de 5 Idiomas (ABAJO DE TODO) -->
      ...
      <!-- BOTÓN COMPARTIR APP POR WHATSAPP -->
      <button id="splash-share-btn" class="splash-share-btn">
        <span class="share-icon">📲</span>
        <span id="txt-splash-share">COMPARTIR JUEGO</span>
      </button>
    </div>
  </div>
  ...
  <div id="app">
    ...
    <header>
      ...
      <!-- HUD MODO ENTRENAMIENTO -->
      <div id="training-hud">
        <button id="training-exit-btn" class="training-btn-exit"><span id="txt-train-exit">← ATRÁS</span></button>
  ...
  <script>
    ...
    const I18N = {
      es: {
        ...
        playBtn: "JUGAR",
        trainBtn: "ENTRENAR",
        shareBtn: "COMPARTIR JUEGO",
        shareMsg: "¡Jugá a Mi Mundo! 🌍🕹️ ¿Cuánto sabes de capitales y países? ¡Superá mi récord aquí!: ",
        score: "PUNTOS",
        streak: "RACHA",
        level: "NIVEL",
        lives: "VIDAS",
      ...
      en: {
        ...
        trainBtn: "TRAIN",
        shareBtn: "SHARE GAME",
        shareMsg: "Play My World! 🌍🕹️ Test your geography skills and beat my high score here: ",
        score: "SCORE",
        streak: "STREAK",
        level: "LEVEL",
        lives: "LIVES",
      ...
      ja: {
        ...
        trainBtn: "練習",
        shareBtn: "ゲームをシェア",
        shareMsg: "『私の世界』で遊ぼう！🌍🕹️ 国名や首都のクイズで私のハイスコアを超えられるかな？プレイはこちら： ",
        score: "スコア",
        streak: "連勝",
        level: "レベル",
        lives: "ライフ",
        ...
        thPts: "スコア",
        mainMenuBtn: "ホームに戻る",
        ufoToastBig: "🛸 <span class='alien-hunted-badge'>👽<span class='alien-cross-line'></span></span> UFO撃墜！x2 ボーナス",
        ufoToastSmall: "🛸 <span class='alien-hunted-badge'>👽<span class='alien-cross-line'></span></span> 高速UFO！x4 ボーナス",
        ufoBombBoom: "💥 ドカン！💀 -200 点",
        comicPhrases: {
          2: ["いこう！ 🚀", "ナイス！ ✨", "最高！ 🔥", "ドカン！ 💥"],
          3: ["天才！ 🧠⚡", "素晴らしい！ 🌟", "その調子！ 💪", "ザップ！ ⚡"],
          4: ["チャンピオン！ 🏆", "無敵！ 🔥", "マスター！ 👑", "パウ！ 💥"],
          5: ["伝説レベル！ 🌟👑", "世界の覇者！ 🌍🔥", "パーフェクト！ 💎", "バム！ 💣"]
        }
      },
      zh: {
        appTitle: "我的世界",
        ...
        trainBtn: "训练模式",
        shareBtn: "分享游戏",
        shareMsg: "快来玩《我的世界》地理大挑战！🌍🕹️ 挑战各国首都与地理知识，超越我的最高分： ",
        score: "得分",
        streak: "连胜",
        level: "难度",
        lives: "生命",
        ...
        thPts: "得分",
        mainMenuBtn: "返回主页",
        ufoToastBig: "🛸 <span class='alien-hunted-badge'>👽<span class='alien-cross-line'></span></span> 击落UFO！x2 奖励",
        ufoToastSmall: "🛸 <span class='alien-hunted-badge'>👽<span class='alien-cross-line'></span></span> 极速UFO！x4 奖励",
        ufoBombBoom: "💥 轰！💀 -200 分",
        comicPhrases: {
          2: ["加油！ 🚀", "太棒了！ ✨", "太厉害了！ 🔥", "轰！ 💥"],
          3: ["天才！ 🧠⚡", "超神！ 🌟", "继续保持！ 💪", "电击！ ⚡"],
      ...
      ar: {
        ...
        easySub: "16 ثوانٍ • x1",
        med: "متوسط",
        medSub: "10 ثوانٍ • x1.5",
        exp: "خبير",
        expSub: "5 ثوانٍ • x2.0 ⚡",
        playBtn: "العب",
        trainBtn: "تدريب",
        shareBtn: "مشاركة اللعبة",
        shareMsg: "العب لعبة عالمي! 🌍🕹️ اختبر معلوماتك في الجغرافيا والدول وحطم رقمي القياسي هنا: ",
        score: "النقاط",
        streak: "التتابع",
        level: "المستوى",
        lives: "المحاولات",
        ...
        trainExit: "← رجوع",
        spinBtn: "أدر العالم!",
        spinningBtn: "جارٍ الدوران...",
        nextSpinBtn: "الدورة التالية!",
        spinAgainBtn: "أدر مجدداً!",
        ...
        ufoToastBig: "🛸 <span class='alien-hunted-badge'>👽<span class='alien-cross-line'></span></span> إسقاط الفضائي! مضاعف x2",
        ufoToastSmall: "🛸 <span class='alien-hunted-badge'>👽<span class='alien-cross-line'></span></span> فضائي سريع! مضاعف x4",
        ufoBombBoom: "💥 بوم! 💀 -200 نقطة",
        comicPhrases: {
          2: ["ممتاز! 🚀", "رائع! ✨", "أحسنت! 🔥", "بوم! 💥"],
          3: ["عبقري! 🧠⚡", "نجم ساطع! 🌟", "واصل التألق! 💪", "صاعقة! ⚡"],
          4: ["بطل! 🏆", "لا يُقهر! 🔥", "أستاذ! 👑", "ضربة قاضية! 💥"],
          5: ["مستوى الأساطير! 🌟👑", "ملك العالم! 🌍🔥", "إتقان تام! 💎", "انفجار! 💣"]
        }
      }
    };
    ...
    class TeletypeConsoleManager {
      ...
      startTypewriter(line) {
        if (typeof InactivityManager !== 'undefined') InactivityManager.clear();
        ...
        const typeNextChar = () => {
          ...
          if (charIndex < totalChars) {
            ...
            this.isTyping = false;
            if (typeof InactivityManager !== 'undefined') InactivityManager.reset();
    ...
    class RetroUFOManager {
      constructor(ufoElemId, bombElemId) {
        ...
        // Frecuencia casual de OVNIs SOLO en partida (cada 18s con 40% de probabilidad)
        setInterval(() => {
          const isTriviaOpen = triviaModal && !triviaModal.classList.contains('hidden');
          // NUNCA aparecer en modo entrenamiento
          const isGameActive = globe && !globe.isTrainingMode && !isGameOver && splashScreen.classList.contains('hidden') && gameModal.classList.contains('hidden') && !isTriviaOpen;
          
          if (isGameActive && !this.active && Math.random() < 0.40) {
            this.spawn();
          }
        }, 18000);
      }
      ...
      spawn() {
        const isTriviaOpen = triviaModal && !triviaModal.classList.contains('hidden');
        if (this.active || isTriviaOpen || (globe && globe.isTrainingMode)) return;
        ...
        // Patrones de vuelo erráticos desde distintos ejes (0: Izquierda-Derecha ondulante, 1: Derecha-Izquierda ondulante, 2: Diagonal superior-izq, 3: Diagonal superior-der, 4: Arco parabólico)
        this.pattern = Math.floor(Math.random() * 5);
        this.baseSpeed = this.isFast ? (Math.random() * 2.0 + 2.8) : (Math.random() * 1.2 + 1.4);
        this.flightTime = 0;

        if (this.pattern === 0) {
          // Izquierda -> Derecha ondulante
          this.x = -widthPx;
          this.y = Math.random() * (window.innerHeight * 0.25) + 85;
          this.baseY = this.y;
          this.vx = this.baseSpeed;
          this.vy = 0;
        } else if (this.pattern === 1) {
          // Derecha -> Izquierda ondulante
          this.x = window.innerWidth + widthPx;
          this.y = Math.random() * (window.innerHeight * 0.25) + 85;
          this.baseY = this.y;
          this.vx = -this.baseSpeed;
          this.vy = 0;
        } else if (this.pattern === 2) {
          // Diagonal desde arriba izquierda hacia abajo derecha
          this.x = -widthPx;
          this.y = 50;
          this.vx = this.baseSpeed * 1.1;
          this.vy = this.baseSpeed * 0.55;
          ...
          // Arco desde abajo hacia arriba y cruzando
          const fromLeft = Math.random() > 0.5;
          this.x = fromLeft ? -widthPx : window.innerWidth + widthPx;
          this.y = window.innerHeight * 0.55;
          this.vx = fromLeft ? this.baseSpeed : -this.baseSpeed;
      ...
      updatePos() {
        ...
        this.flightTime += 0.05;

        if (this.pattern === 0 || this.pattern === 1) {
          this.x += this.vx;
          this.y = this.baseY + Math.sin(this.flightTime * 2.5) * 35;
        } else if (this.pattern === 4) {
          this.x += this.vx;
          this.vy += 0.035; // Gravedad suave para formar el arco parabólico
          this.y += this.vy;
        } else {
          this.x += this.vx;
          this.y += this.vy;
          if (Math.random() < 0.04) {
            this.vy += (Math.random() - 0.5) * 1.8; // maniobra errática repentina
          }
        }

        if (this.y < 65) this.y = 65;
        if (this.y > window.innerHeight * 0.65) this.y = window.innerHeight * 0.65;
        ...
        if (now - this.lastZapTime > this.nextZapInterval) {
          ...
          this.nextZapInterval = Math.random() * 1100 + 1000;
        ...
        const outOfBounds = (this.vx > 0 && this.x > window.innerWidth + 90) || (this.vx < 0 && this.x < -90) || (this.y > window.innerHeight * 0.7);
        const expired = (Date.now() - this.timeAlive > 7500);
    ...
    function updateGaugeUI() {
      ...
      const label = document.getElementById('gauge-selected-label');
      document.querySelectorAll('.gauge-segment').forEach(seg => {
        seg.classList.toggle('active', seg.dataset.diff === currentDifficulty);
      });

      const rot = currentDifficulty === 'easy' ? -60 : (currentDifficulty === 'medium' ? 0 : 60);
      const color = currentDifficulty === 'easy' ? '#39ff14' : (currentDifficulty === 'medium' ? '#ffe600' : '#ff0033');
      const t = I18N[currentLang];
      const name = currentDifficulty === 'easy' ? t.easy : (currentDifficulty === 'medium' ? t.med : t.exp);
      const sub = currentDifficulty === 'easy' ? t.easySub : (currentDifficulty === 'medium' ? t.medSub : t.expSub);

      if (needle) needle.style.transform = `rotate(${rot}deg)`;
      if (label) {
        label.textContent = `${name} • ${sub}`;
        label.style.color = color;
        label.style.textShadow = `0 0 10px ${color}`;
      }
    }

    function setupDifficultyGauge() {
      document.querySelectorAll('.gauge-segment').forEach(seg => {
      ...
      const gaugeContainer = document.getElementById('difficulty-gauge-container');
      if (gaugeContainer) {
        gaugeContainer.addEventListener('click', (e) => {
          audioSynth.init();
    ...
    function setLanguage(lang) {
      ...
      document.getElementById('splash-train-btn').textContent = t.trainBtn;
      if (document.getElementById('txt-splash-share')) {
        document.getElementById('txt-splash-share').textContent = t.shareBtn;
      }
    ...
    /* ==========================================================================
       14. GESTOR DE INACTIVIDAD (12 SEGUNDOS EN ENTRENAMIENTO Y SCOREBOARD)
       ========================================================================== */
    ...
    // Compartir por WhatsApp en el idioma activo
    const splashShareBtn = document.getElementById('splash-share-btn');
    if (splashShareBtn) {
      splashShareBtn.addEventListener('click', () => {
        audioSynth.init();
        const shareUrl = 'https://enlacenorte.github.io/mi-mundo/';
        const shareMsg = I18N[currentLang].shareMsg + shareUrl;
